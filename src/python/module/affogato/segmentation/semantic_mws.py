...
from ._segmentation import compute_semantic_mws_clustering, compute_semantic_mws_segmentation_impl
...
def compute_semantic_mws_segmentation(weights, offsets, number_of_attractive_channels,
    ...
    labels, semantic_labels = compute_semantic_mws_segmentation_impl(sorted_flat_indices,
                                                                     valid_edges.ravel(),
                                                                     offsets,
